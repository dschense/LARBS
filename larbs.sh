...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/dschense/voidrice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/dschense/LARBS/master/progs.csv"
